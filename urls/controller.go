...
// for managing urls
func NewController(auth string, redisPool *redis.Pool, mongoSession *mgo.Session, redisNamespace, shortProtocol string) Controller {
	service := newService(redisPool, mongoSession, redisNamespace, shortProtocol)
